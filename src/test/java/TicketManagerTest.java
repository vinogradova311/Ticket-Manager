...
public class TicketManagerTest {
    ...
    TicketsByTimeComparator timeComparator = new TicketsByTimeComparator();
    ...
    public void searchAndSortByTimeTest() {
        ...
        Ticket[] expected = {item1, item6};
        Ticket[] actual = manager.searchByAndSortByTime("LED", "SVO", timeComparator);
        Assertions.assertArrayEquals(expected, actual);
    }

    @Test
    public void searchAndSortByTime2Test() {
        manager.add(item1);
        manager.add(item2);
        manager.add(item3);
        manager.add(item4);
        ...
        Ticket[] expected = {item3, item2};
        Ticket[] actual = manager.searchByAndSortByTime("SVO", "LED", timeComparator);
        Assertions.assertArrayEquals(expected, actual);
    }
